...
from providers import _valid_schema_fields, get_provider_config_schemas
...
def test_builtin_provider_schemas_are_discovered():
    ...
    assert any(field["type"] == "secret" for field in by_key["nug"]["fields"])
...
def test_fake_provider_schema_appears_without_settings_code_changes(monkeypatch):
    ...
    base = {
        "config_version": 2,
        "providers": {"atlas": {"enabled": True, "api_key": "atlas-secret"}},
        "dashboard": {},
    }
